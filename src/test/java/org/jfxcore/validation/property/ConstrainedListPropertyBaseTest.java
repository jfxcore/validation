...
import org.jfxcore.validation.mocks.MockListObserver;
import org.jfxcore.validation.mocks.ObservableObjectValueStub;
import org.jfxcore.validation.mocks.Person;
...
public class ConstrainedListPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedListProperty<Object, Object> p1 = new SimpleConstrainedListProperty<Object, Object>();
        assertEquals(null, p1.get());
        assertEquals(null, p1.getValue());
        assertFalse(property.isBound());

        final ConstrainedListProperty<Object, Object> p2 = new SimpleConstrainedListProperty<Object, Object>(VALUE_1b);
    ...
    public void testSetBoundValue() {
        final ConstrainedListProperty<Object, Object> v = new SimpleConstrainedListProperty<Object, Object>(VALUE_1a);
        property.bind(v);
        assertThrows(RuntimeException.class, () -> property.set(VALUE_1a));
    }
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedListProperty<Object, Object> v1 = new SimpleConstrainedListProperty<Object, Object>(VALUE_1a);
        final ConstrainedListProperty<Object, Object> v2 = new SimpleConstrainedListProperty<Object, Object>(VALUE_2a);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testRebind_Identity() {
        final ConstrainedListProperty<Object, Object> v1 = new SimpleConstrainedListProperty<>(FXCollections.observableArrayList());
        final ConstrainedListProperty<Object, Object> v2 = new SimpleConstrainedListProperty<>(FXCollections.observableArrayList());
        attachListChangeListener();
        ...
        assertEquals("ConstrainedListProperty [bound, value: [One, Two]]", property.toString());
    }
    ...
    public void testUpdate() {
        ...
        ConstrainedListProperty<Person, Object> property = new SimpleConstrainedListProperty<>(list);
    ...
    public void testPermutationUpdate() {
        ...
        ConstrainedListProperty<Person, Object> property = new SimpleConstrainedListProperty<>(sorted);
        MockListObserver<Person> mlo = new MockListObserver<>();
        property.addListener(mlo);
    ...
    public void testToString() {
        ...
        final ConstrainedListProperty<Object, Object> v = new SimpleConstrainedListProperty<Object, Object>(value2);

        property.set(value1);
        assertEquals("ConstrainedListProperty [value: " + value1 + "]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedListProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedListProperty [bound, value: " + value2 + "]", property.toString());
        v.set(value1);
        assertEquals("ConstrainedListProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedListProperty [bound, value: " + value1 + "]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedListProperty<Object, Object> v1 = new ListPropertyMock(bean, name);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", name: My name, value: " + null + "]", v1.toString());
        v1.set(value1);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]", v1.toString());
        v1.set(value0);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedListProperty<Object, Object> v2 = new ListPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", value: " + null + "]", v2.toString());
        v2.set(value1);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v2.toString());
        v1.set(value0);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedListProperty<Object, Object> v3 = new ListPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", value: " + null + "]", v3.toString());
        v3.set(value1);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v3.toString());
        v1.set(value0);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedListProperty<Object, Object> v4 = new ListPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedListProperty [name: My name, value: " + null + "]", v4.toString());
        v4.set(value1);
        v1.set(value0);
        assertEquals("ConstrainedListProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());
        assertEquals("ConstrainedListProperty [name: My name, value: " + value1 + "]", v4.toString());
    }

    private static class ListPropertyMock extends ConstrainedListPropertyBase<Object, Object> {
