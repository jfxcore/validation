...
import org.jfxcore.validation.mocks.ObservableFloatValueStub;
...
public class ConstrainedFloatPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedFloatProperty<Object> p1 = new SimpleConstrainedFloatProperty<>();
        assertEquals(0.0f, p1.get(), EPSILON);
        assertEquals(Float.valueOf(0.0f), p1.getValue(), EPSILON);
        assertFalse(property.isBound());

        final ConstrainedFloatProperty<Object> p2 = new SimpleConstrainedFloatProperty<>(-PI);
    ...
    public void testSetBoundValue() {
        final ConstrainedFloatProperty<Object> v = new SimpleConstrainedFloatProperty<>(PI);
        property.bind(v);
        assertThrows(RuntimeException.class, () -> property.set(PI));
    }
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedFloatProperty<Object> v1 = new SimpleConstrainedFloatProperty<>(PI);
        final ConstrainedFloatProperty<Object> v2 = new SimpleConstrainedFloatProperty<>(E);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testToString() {
        ...
        final ConstrainedFloatProperty<Object> v = new SimpleConstrainedFloatProperty<>(value2);

        property.set(value1);
        assertEquals("ConstrainedFloatProperty [value: " + value1 + "]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedFloatProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedFloatProperty [bound, value: " + value2 + "]", property.toString());
        v.set(value1);
        assertEquals("ConstrainedFloatProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedFloatProperty [bound, value: " + value1 + "]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedFloatProperty<Object> v1 = new FloatPropertyMock(bean, name);
        assertEquals("ConstrainedFloatProperty [bean: " + bean.toString() + ", name: My name, value: " + 0.0f + "]", v1.toString());
        v1.set(value1);
        assertEquals("ConstrainedFloatProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]", v1.toString());

        final ConstrainedFloatProperty<Object> v2 = new FloatPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedFloatProperty [bean: " + bean.toString() + ", value: " + 0.0f + "]", v2.toString());
        v2.set(value1);
        assertEquals("ConstrainedFloatProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v2.toString());

        final ConstrainedFloatProperty<Object> v3 = new FloatPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedFloatProperty [bean: " + bean.toString() + ", value: " + 0.0f + "]", v3.toString());
        v3.set(value1);
        assertEquals("ConstrainedFloatProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v3.toString());

        final ConstrainedFloatProperty<Object> v4 = new FloatPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedFloatProperty [name: My name, value: " + 0.0f + "]", v4.toString());
        v4.set(value1);
        assertEquals("ConstrainedFloatProperty [name: My name, value: " + value1 + "]", v4.toString());
    }

    private static class FloatPropertyMock extends ConstrainedFloatPropertyBase<Object> {
