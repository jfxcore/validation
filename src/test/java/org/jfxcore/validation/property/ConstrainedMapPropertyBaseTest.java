...
import org.jfxcore.validation.mocks.MockMapObserver;
...
import static org.jfxcore.validation.mocks.MockMapObserver.*;
import static org.junit.jupiter.api.Assertions.*;

public class ConstrainedMapPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedMapProperty<Object, Object, Object> p1 = new SimpleConstrainedMapProperty<>();
        assertEquals(null, p1.get());
        assertEquals(null, p1.getValue());
        assertFalse(property.isBound());

        final ConstrainedMapProperty<Object, Object, Object> p2 = new SimpleConstrainedMapProperty<>(VALUE_1b);
    ...
    public void testMapBoundValue() {
        final ConstrainedMapProperty<Object, Object, Object> v = new SimpleConstrainedMapProperty<>(VALUE_1a);
        property.bind(v);
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedMapProperty<Object, Object, Object> v1 = new SimpleConstrainedMapProperty<>(VALUE_1a);
        final ConstrainedMapProperty<Object, Object, Object> v2 = new SimpleConstrainedMapProperty<>(VALUE_2a);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testRebind_Identity() {
        final ConstrainedMapProperty<Object, Object, Object> v1 = new SimpleConstrainedMapProperty<>(FXCollections.observableHashMap());
        final ConstrainedMapProperty<Object, Object, Object> v2 = new SimpleConstrainedMapProperty<>(FXCollections.observableHashMap());
        attachMapChangeListener();
        ...
        v2.put("One", "1");
        mapChangeListener.assertAdded(Tuple.tup("One", "1"));
        mapChangeListener.clear();

        v2.put("Two", "2");
        mapChangeListener.assertAdded(Tuple.tup("Two", "2"));
        mapChangeListener.clear();

        property.check(4);
        assertTrue(property.isBound());
        assertEquals(2, property.size());
        assertEquals("ConstrainedMapProperty [bound, value: {One=1, Two=2}]", property.toString());
    }
    ...
    public void testToString() {
        ...
        final ConstrainedMapProperty<Object, Object, Object> v = new SimpleConstrainedMapProperty<>(value2);

        property.set(value1);
        assertEquals("ConstrainedMapProperty [value: " + value1 + "]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedMapProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedMapProperty [bound, value: " + value2 + "]", property.toString());
        v.set(value1);
        assertEquals("ConstrainedMapProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedMapProperty [bound, value: " + value1 + "]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedMapProperty<Object, Object, Object> v1 = new MapPropertyMock(bean, name);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", name: My name, value: " + null + "]", v1.toString());
        v1.set(value1);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]", v1.toString());
        v1.set(value0);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedMapProperty<Object, Object, Object> v2 = new MapPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", value: " + null + "]", v2.toString());
        v2.set(value1);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v2.toString());
        v1.set(value0);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedMapProperty<Object, Object, Object> v3 = new MapPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", value: " + null + "]", v3.toString());
        v3.set(value1);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v3.toString());
        v1.set(value0);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedMapProperty<Object, Object, Object> v4 = new MapPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedMapProperty [name: My name, value: " + null + "]", v4.toString());
        v4.set(value1);
        v1.set(value0);
        assertEquals("ConstrainedMapProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());
        assertEquals("ConstrainedMapProperty [name: My name, value: " + value1 + "]", v4.toString());
    }

    private static class MapPropertyMock extends ConstrainedMapPropertyBase<Object, Object, Object> {
