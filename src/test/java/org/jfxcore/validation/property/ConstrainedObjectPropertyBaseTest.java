...
public class ConstrainedObjectPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedObjectProperty<Object, Object> p1 = new SimpleConstrainedObjectProperty<>();
        assertEquals(null, p1.get());
        assertEquals(null, p1.getValue());
        assertFalse(property.isBound());

        final ConstrainedObjectProperty<Object, Object> p2 = new SimpleConstrainedObjectProperty<>(VALUE_1b);
    ...
    public void testSetBoundValue() {
        final ConstrainedObjectProperty<Object, Object> v = new SimpleConstrainedObjectProperty<>(VALUE_1a);
        property.bind(v);
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedObjectProperty<Object, Object> v1 = new SimpleConstrainedObjectProperty<>(VALUE_1a);
        final ConstrainedObjectProperty<Object, Object> v2 = new SimpleConstrainedObjectProperty<>(VALUE_2a);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testToString() {
        ...
        final ConstrainedObjectProperty<Object, Object> v = new SimpleConstrainedObjectProperty<>(value2);

        property.set(value1);
        assertEquals("ConstrainedObjectProperty [value: " + value1 + "]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedObjectProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedObjectProperty [bound, value: " + value2 + "]", property.toString());
        v.set(value1);
        assertEquals("ConstrainedObjectProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedObjectProperty [bound, value: " + value1 + "]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedObjectProperty<Object, Object> v1 = new ObjectPropertyMock(bean, name);
        assertEquals("ConstrainedObjectProperty [bean: " + bean.toString() + ", name: My name, value: " + null + "]", v1.toString());
        v1.set(value1);
        assertEquals("ConstrainedObjectProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]", v1.toString());

        final ConstrainedObjectProperty<Object, Object> v2 = new ObjectPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedObjectProperty [bean: " + bean.toString() + ", value: " + null + "]", v2.toString());
        v2.set(value1);
        assertEquals("ConstrainedObjectProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v2.toString());

        final ConstrainedObjectProperty<Object, Object> v3 = new ObjectPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedObjectProperty [bean: " + bean.toString() + ", value: " + null + "]", v3.toString());
        v3.set(value1);
        assertEquals("ConstrainedObjectProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v3.toString());

        final ConstrainedObjectProperty<Object, Object> v4 = new ObjectPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedObjectProperty [name: My name, value: " + null + "]", v4.toString());
        v4.set(value1);
        assertEquals("ConstrainedObjectProperty [name: My name, value: " + value1 + "]", v4.toString());
    }

    private static class ObjectPropertyMock extends ConstrainedObjectPropertyBase<Object, Object> {
