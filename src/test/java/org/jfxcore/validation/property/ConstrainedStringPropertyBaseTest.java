...
import org.jfxcore.validation.mocks.ObservableStringValueStub;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

import static org.junit.jupiter.api.Assertions.*;

public class ConstrainedStringPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedStringProperty<Object> p1 = new SimpleConstrainedStringProperty<>();
        assertEquals(null, p1.get());
        assertEquals(null, p1.getValue());
        assertFalse(property.isBound());

        final ConstrainedStringProperty<Object> p2 = new SimpleConstrainedStringProperty<>(VALUE_1b);
    ...
    public void testSetBoundValue() {
        final ConstrainedStringProperty<Object> v = new SimpleConstrainedStringProperty<>(VALUE_1a);
        property.bind(v);
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedStringProperty<Object> v1 = new SimpleConstrainedStringProperty<>(VALUE_1a);
        final ConstrainedStringProperty<Object> v2 = new SimpleConstrainedStringProperty<>(VALUE_2a);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testToString() {
        ...
        final ConstrainedStringProperty<Object> v = new SimpleConstrainedStringProperty<>(value2);

        property.set(value1);
        assertEquals("ConstrainedStringProperty [value: " + value1 + "]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedStringProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedStringProperty [bound, value: " + value2 + "]", property.toString());
        v.set(value1);
        assertEquals("ConstrainedStringProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedStringProperty [bound, value: " + value1 + "]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedStringProperty<Object> v1 = new StringPropertyMock(bean, name);
        assertEquals("ConstrainedStringProperty [bean: " + bean.toString() + ", name: My name, value: " + null + "]", v1.toString());
        v1.set(value1);
        assertEquals("ConstrainedStringProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]", v1.toString());

        final ConstrainedStringProperty<Object> v2 = new StringPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedStringProperty [bean: " + bean.toString() + ", value: " + null + "]", v2.toString());
        v2.set(value1);
        assertEquals("ConstrainedStringProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v2.toString());

        final ConstrainedStringProperty<Object> v3 = new StringPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedStringProperty [bean: " + bean.toString() + ", value: " + null + "]", v3.toString());
        v3.set(value1);
        assertEquals("ConstrainedStringProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v3.toString());

        final ConstrainedStringProperty<Object> v4 = new StringPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedStringProperty [name: My name, value: " + null + "]", v4.toString());
        v4.set(value1);
        assertEquals("ConstrainedStringProperty [name: My name, value: " + value1 + "]", v4.toString());
    }

    private static class StringPropertyMock extends ConstrainedStringPropertyBase<Object> {
