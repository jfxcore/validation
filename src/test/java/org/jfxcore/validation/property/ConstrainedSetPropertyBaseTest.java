...
import org.jfxcore.validation.mocks.MockSetObserver;
...
import static org.jfxcore.validation.mocks.MockSetObserver.*;
import static org.junit.jupiter.api.Assertions.*;

public class ConstrainedSetPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedSetProperty<Object, Object> p1 = new SimpleConstrainedSetProperty<>();
        assertEquals(null, p1.get());
        assertEquals(null, p1.getValue());
        assertFalse(property.isBound());

        final ConstrainedSetProperty<Object, Object> p2 = new SimpleConstrainedSetProperty<>(VALUE_1b);
    ...
    public void testSetBoundValue() {
        final ConstrainedSetProperty<Object, Object> v = new SimpleConstrainedSetProperty<>(VALUE_1a);
        property.bind(v);
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedSetProperty<Object, Object> v1 = new SimpleConstrainedSetProperty<>(VALUE_1a);
        final ConstrainedSetProperty<Object, Object> v2 = new SimpleConstrainedSetProperty<>(VALUE_2a);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testRebind_Identity() {
        final ConstrainedSetProperty<Object, Object> v1 = new SimpleConstrainedSetProperty<>(FXCollections.observableSet());
        final ConstrainedSetProperty<Object, Object> v2 = new SimpleConstrainedSetProperty<>(FXCollections.observableSet());
        attachSetChangeListener();
        ...
        assertEquals("ConstrainedSetProperty [bound, value: [Two, One]]", property.toString());
    }
    ...
    public void testToString() {
        ...
        final ConstrainedSetProperty<Object, Object> v = new SimpleConstrainedSetProperty<>(value2);

        property.set(value1);
        assertEquals("ConstrainedSetProperty [value: " + value1 + "]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedSetProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedSetProperty [bound, value: " + value2 + "]", property.toString());
        v.set(value1);
        assertEquals("ConstrainedSetProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedSetProperty [bound, value: " + value1 + "]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedSetProperty<Object, Object> v1 = new SetPropertyMock(bean, name);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", name: My name, value: " + null + "]", v1.toString());
        v1.set(value1);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]", v1.toString());
        v1.set(value0);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedSetProperty<Object, Object> v2 = new SetPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", value: " + null + "]", v2.toString());
        v2.set(value1);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v2.toString());
        v1.set(value0);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedSetProperty<Object, Object> v3 = new SetPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", value: " + null + "]", v3.toString());
        v3.set(value1);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v3.toString());
        v1.set(value0);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());

        final ConstrainedSetProperty<Object, Object> v4 = new SetPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedSetProperty [name: My name, value: " + null + "]", v4.toString());
        v4.set(value1);
        v1.set(value0);
        assertEquals("ConstrainedSetProperty [bean: " + bean.toString() + ", name: My name, value: " + value0 + "]", v1.toString());
        assertEquals("ConstrainedSetProperty [name: My name, value: " + value1 + "]", v4.toString());
    }

    private static class SetPropertyMock extends ConstrainedSetPropertyBase<Object, Object> {
