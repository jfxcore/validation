...
import org.jfxcore.validation.mocks.ObservableBooleanValueStub;
...
public class ConstrainedBooleanPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedBooleanProperty<Object> p1 = new SimpleConstrainedBooleanProperty<>();
        assertEquals(false, p1.get());
        assertEquals(Boolean.FALSE, p1.getValue());
        assertFalse(property.isBound());

        final ConstrainedBooleanProperty<Object> p2 = new SimpleConstrainedBooleanProperty<>(true);
    ...
    public void testSetBoundValue() {
        final ConstrainedBooleanProperty<Object> v = new SimpleConstrainedBooleanProperty<>(true);
        property.bind(v);
        assertThrows(RuntimeException.class, () -> property.set(true));
    }
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedBooleanProperty<Object> v1 = new SimpleConstrainedBooleanProperty<>(true);
        final ConstrainedBooleanProperty<Object> v2 = new SimpleConstrainedBooleanProperty<>(false);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testToString() {
        ...
        property.set(true);
        assertEquals("ConstrainedBooleanProperty [value: true]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedBooleanProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedBooleanProperty [bound, value: true]", property.toString());
        v.set(false);
        assertEquals("ConstrainedBooleanProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedBooleanProperty [bound, value: false]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedBooleanProperty<Object> v1 = new BooleanPropertyMock(bean, name);
        assertEquals("ConstrainedBooleanProperty [bean: " + bean.toString() + ", name: My name, value: false]", v1.toString());
        v1.set(true);
        assertEquals("ConstrainedBooleanProperty [bean: " + bean.toString() + ", name: My name, value: true]", v1.toString());

        final ConstrainedBooleanProperty<Object> v2 = new BooleanPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedBooleanProperty [bean: " + bean.toString() + ", value: false]", v2.toString());
        v2.set(true);
        assertEquals("ConstrainedBooleanProperty [bean: " + bean.toString() + ", value: true]", v2.toString());

        final ConstrainedBooleanProperty<Object> v3 = new BooleanPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedBooleanProperty [bean: " + bean.toString() + ", value: false]", v3.toString());
        v3.set(true);
        assertEquals("ConstrainedBooleanProperty [bean: " + bean.toString() + ", value: true]", v3.toString());

        final ConstrainedBooleanProperty<Object> v4 = new BooleanPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedBooleanProperty [name: My name, value: false]", v4.toString());
        v4.set(true);
        assertEquals("ConstrainedBooleanProperty [name: My name, value: true]", v4.toString());
    }

    private static class BooleanPropertyMock extends ConstrainedBooleanPropertyBase<Object> {
