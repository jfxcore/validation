...
import org.jfxcore.validation.mocks.ObservableLongValueStub;
...
public class ConstrainedLongPropertyBaseTest {
    ...
    public void testConstructor() {
        final ConstrainedLongProperty<Object> p1 = new SimpleConstrainedLongProperty<>();
        assertEquals(0, p1.get());
        assertEquals(Long.valueOf(0), p1.getValue());
        assertFalse(property.isBound());

        final ConstrainedLongProperty<Object> p2 = new SimpleConstrainedLongProperty<>(-VALUE_1);
    ...
    public void testSetBoundValue() {
        final ConstrainedLongProperty<Object> v = new SimpleConstrainedLongProperty<>(VALUE_1);
        property.bind(v);
    ...
    public void testRebind() {
        attachInvalidationListener();
        final ConstrainedLongProperty<Object> v1 = new SimpleConstrainedLongProperty<>(VALUE_1);
        final ConstrainedLongProperty<Object> v2 = new SimpleConstrainedLongProperty<>(VALUE_2);
        property.bind(v1);
        property.get();
        property.reset();
        invalidationListener.reset();
    ...
    public void testToString() {
        ...
        final ConstrainedLongProperty<Object> v = new SimpleConstrainedLongProperty<>(value2);

        property.set(value1);
        assertEquals("ConstrainedLongProperty [value: " + value1 + "]", property.toString());

        property.bind(v);
        assertEquals("ConstrainedLongProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedLongProperty [bound, value: " + value2 + "]", property.toString());
        v.set(value1);
        assertEquals("ConstrainedLongProperty [bound, invalid]", property.toString());
        property.get();
        assertEquals("ConstrainedLongProperty [bound, value: " + value1 + "]", property.toString());

        final Object bean = new Object();
        final String name = "My name";
        final ConstrainedLongProperty<Object> v1 = new LongPropertyMock(bean, name);
        assertEquals("ConstrainedLongProperty [bean: " + bean.toString() + ", name: My name, value: " + 0L + "]", v1.toString());
        v1.set(value1);
        assertEquals("ConstrainedLongProperty [bean: " + bean.toString() + ", name: My name, value: " + value1 + "]", v1.toString());

        final ConstrainedLongProperty<Object> v2 = new LongPropertyMock(bean, NO_NAME_1);
        assertEquals("ConstrainedLongProperty [bean: " + bean.toString() + ", value: " + 0L + "]", v2.toString());
        v2.set(value1);
        assertEquals("ConstrainedLongProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v2.toString());

        final ConstrainedLongProperty<Object> v3 = new LongPropertyMock(bean, NO_NAME_2);
        assertEquals("ConstrainedLongProperty [bean: " + bean.toString() + ", value: " + 0L + "]", v3.toString());
        v3.set(value1);
        assertEquals("ConstrainedLongProperty [bean: " + bean.toString() + ", value: " + value1 + "]", v3.toString());

        final ConstrainedLongProperty<Object> v4 = new LongPropertyMock(NO_BEAN, name);
        assertEquals("ConstrainedLongProperty [name: My name, value: " + 0L + "]", v4.toString());
        v4.set(value1);
        assertEquals("ConstrainedLongProperty [name: My name, value: " + value1 + "]", v4.toString());
    }

    private static class LongPropertyMock extends ConstrainedLongPropertyBase<Object> {
