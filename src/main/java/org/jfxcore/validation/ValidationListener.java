...
public interface ValidationListener<T, D> {
    ...
    enum ChangeType {
        /**
         * Indicates that the <em>valid</em> state has changed.
         */
        VALID,

        /**
         * Indicates that the <em>invalid</em> state has changed.
         */
        INVALID,

        /**
         * Indicates that the <em>validating</em> state has changed.
         */
        VALIDATING
    }
