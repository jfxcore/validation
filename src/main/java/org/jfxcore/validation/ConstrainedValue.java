...
public interface ConstrainedValue<T, D> {
     ...
     *
     * @param listener the {@code ValidationListener} to be added
     */
     ...
     *
     * @param listener the {@code ValidationListener} to be removed
     */
     ...
     * </ul>
     *
     * @return the list of validation diagnostics
     */
     ...
     *
     * @return {@code true} if the value is being validated, {@code false} otherwise
     */
