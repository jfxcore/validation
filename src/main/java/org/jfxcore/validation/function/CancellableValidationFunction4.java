...
/**
 * Represents a cancellable validation function with four dependencies.
 *
 ...
 */
@FunctionalInterface
public interface CancellableValidationFunction4<T, P1, P2, P3, P4, D> {

    /**
     * Applies this function to the given arguments.
     */
    ValidationResult<D> apply(T value, P1 dependency1, P2 dependency2, P3 dependency3, P4 dependency4, AtomicBoolean cancellationRequested);
