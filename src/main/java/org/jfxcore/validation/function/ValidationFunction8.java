 ...
 */
@FunctionalInterface
public interface ValidationFunction8<T, P1, P2, P3, P4, P5, P6, P7, P8, D> {

    /**
     * Applies this function to the given arguments.
     */
    ValidationResult<D> apply(T value, P1 dependency1, P2 dependency2, P3 dependency3, P4 dependency4, P5 dependency5, P6 dependency6, P7 dependency7, P8 dependency8);
