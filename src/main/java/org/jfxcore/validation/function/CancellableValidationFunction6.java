...
/**
 * Represents a cancellable validation function with six dependencies.
 *
 ...
 */
@FunctionalInterface
public interface CancellableValidationFunction6<T, P1, P2, P3, P4, P5, P6, D> {

    /**
     * Applies this function to the given arguments.
     */
    ValidationResult<D> apply(T value, P1 dependency1, P2 dependency2, P3 dependency3, P4 dependency4, P5 dependency5, P6 dependency6, AtomicBoolean cancellationRequested);
