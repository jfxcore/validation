...
public interface DiagnosticList<D> extends ObservableList<D> {
     ...
     *
     * @param index the index of the diagnostic
     * @return {@code true} if the diagnostic is valid, {@code false} otherwise
     */
     ...
     *
     * @return a sublist view of valid diagnostics
     */
     ...
     *
     * @return a sublist view of invalid diagnostics
     */
