 ...
 */
public abstract sealed class ReadOnlyConstrainedIntegerProperty<D>
        extends ReadOnlyIntegerPropertyBase
        implements ReadOnlyConstrainedProperty<Number, D>
        permits ConstrainedIntegerProperty, ReadOnlyConstrainedIntegerWrapper.ReadOnlyPropertyImpl {

    /**
     * Creates a default {@code ReadOnlyConstrainedIntegerProperty}.
     */
    protected ReadOnlyConstrainedIntegerProperty() {}
