 ...
 */
public abstract sealed class ReadOnlyConstrainedLongProperty<D>
        extends ReadOnlyLongPropertyBase
        implements ReadOnlyConstrainedProperty<Number, D>
        permits ConstrainedLongProperty, ReadOnlyConstrainedLongWrapper.ReadOnlyPropertyImpl {

    /**
     * Creates a default {@code ReadOnlyConstrainedLongProperty}.
     */
    protected ReadOnlyConstrainedLongProperty() {}
