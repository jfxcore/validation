...
public class ReadOnlyConstrainedDoubleWrapper<D> extends SimpleConstrainedDoubleProperty<D> {
    ...
    /**
     * Initializes a new instance of {@code ReadOnlyConstrainedDoubleWrapper}.
     ...
     *
     * @param initialValue the initial value of this {@code ReadOnlyConstrainedDoubleWrapper}
     * @param initialValidationState the initial validation state of this {@code ReadOnlyConstrainedDoubleWrapper}
     * @param constraints the value constraints
     */
    @SafeVarargs
    ...
    final class ReadOnlyPropertyImpl extends ReadOnlyConstrainedDoubleProperty<D> {
        ...
        public void addListener(ValidationListener<? super Number, D> listener) {
            ReadOnlyConstrainedDoubleWrapper.this.addListener(new ValidationListenerWrapper<>(this, listener));
        }

        @Override
        public void removeListener(ValidationListener<? super Number, D> listener) {
            ReadOnlyConstrainedDoubleWrapper.this.removeListener(new ValidationListenerWrapper<>(this, listener));
        }
        ...
        public Double getConstrainedValue() {
            return ReadOnlyConstrainedDoubleWrapper.this.getConstrainedValue();
        }
    }
