...
public class SimpleConstrainedFloatProperty<D> extends ConstrainedFloatPropertyBase<D> {
    ...
    /**
     * Initializes a new instance of {@code SimpleConstrainedFloatProperty}.
     ...
     * The specified constraints are immediately evaluated.
     *
     * @param initialValue the initial value of this {@code SimpleConstrainedFloatProperty}
     * @param constraints the value constraints
     */
    @SafeVarargs
     ...
     *
     * @param initialValue the initial value of this {@code SimpleConstrainedFloatProperty}
     * @param initialValidationState the initial validation state of this {@code SimpleConstrainedFloatProperty}
     * @param constraints the value constraints
     */
    @SafeVarargs
     ...
     * The specified constraints are immediately evaluated.
     *
     * @param bean the bean of this {@code SimpleConstrainedFloatProperty}
     * @param name the name of this {@code SimpleConstrainedFloatProperty}
     * @param constraints the value constraints
     */
    @SafeVarargs
