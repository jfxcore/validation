...
public class ReadOnlyConstrainedLongWrapper<D> extends SimpleConstrainedLongProperty<D> {
    ...
    final class ReadOnlyPropertyImpl extends ReadOnlyConstrainedLongProperty<D> {
        @Override
        ...
        public boolean isUserValid() {
            return ReadOnlyConstrainedLongWrapper.this.isUserValid();
        }
        ...
        public boolean isUserInvalid() {
            return ReadOnlyConstrainedLongWrapper.this.isUserInvalid();
        }
