 ...
 */
public abstract sealed class ReadOnlyConstrainedStringProperty<D>
        extends ReadOnlyStringPropertyBase
        implements ReadOnlyConstrainedProperty<String, D>
        permits ConstrainedStringProperty, ReadOnlyConstrainedStringWrapper.ReadOnlyPropertyImpl {

    /**
     * Creates a default {@code ReadOnlyConstrainedStringProperty}.
     */
    protected ReadOnlyConstrainedStringProperty() {}
